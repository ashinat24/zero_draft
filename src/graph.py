...
class Workflow():
    def __init__(self):
        ...
        workflow.add_node("generate_contract_from_email", nodes.generate_contract_from_email)
        ...
        {
            "contract draft request": "generate_contract_from_email",  # <-- should match the ROUTE string
            "contract review": "construct_rag_queries",
            "legal query": "construct_rag_queries",
            "unrelated": "skip_unrelated_email",
            "other": "skip_unrelated_email"
        }
    )
        ...
        workflow.add_edge("generate_contract_from_email", "email_writer")
